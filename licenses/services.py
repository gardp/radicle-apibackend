...
def generate_license_agreement(license_obj):
    if HTML is None:
        return # raise Exception("WeasyPrint is not installed. Please install it to generate license agreements.")
...
def send_license_email(
    ...
    for license in licenses:
        if license.license_agreement_file:
            ...
            attachments.append((license.license_agreement_file.name, license.license_agreement_file.read(), "application/pdf"))
